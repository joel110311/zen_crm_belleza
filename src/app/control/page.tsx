...
import { getMercadoPagoControlState } from "@/lib/billing/platform-runtime";
...
export default async function ControlCenterPage() {
    ...
    const mercadoPago = await getMercadoPagoControlState();
