                ...
                {step === 0 ? (
                    <div className="space-y-5">
                        ...
                        {value.cancellation.manageByChat ? <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <Choice label="Tolerancia de retraso" value={String(value.cancellation.lateArrivalToleranceMinutes)} onChange={(lateArrivalToleranceMinutes) => update({ cancellation: { ...value.cancellation, lateArrivalToleranceMinutes: Number(lateArrivalToleranceMinutes) } })} options={[["0", "Sin tolerancia"], ["5", "5 minutos"], ["10", "10 minutos"], ["15", "15 minutos"], ["20", "20 minutos"]]} />
