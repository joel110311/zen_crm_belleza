...
/**
 * Settings that are safe to use as a tenant database's first-run defaults.
 * Secrets remain empty unless that tenant's wizard writes them into its own database.
 */
export const SYSTEM_SETTINGS_DEFAULTS = {
    ...
    messageBatchWindowMs: 8000,
    messageBatchMaxWaitMs: 30000,
    isBotEnabled: false,
    ...
    businessWeeklySchedule: buildUniformBusinessWeeklySchedule(DEFAULT_BUSINESS_HOURS_START, DEFAULT_BUSINESS_HOURS_END, true),
